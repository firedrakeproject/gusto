...
from gusto import (
    ...
    CompressibleEulerEquations, SubcyclingOptions, RungeKuttaFormulation, BruntVaisalaFrequencySquared, 
    ScorerParameterSquared
)
...
def schaer_mountain(
    ...
    sponge = SpongeLayerParameters(mesh,
    ...
    diagnostic_fields = [
        ...
        Perturbation('rho'), 
        BruntVaisalaFrequencySquared(eqns), 
        ScorerParameterSquared(eqns)
    ]
