...
opts = ('domain', 'tmax', 'output', 'f_init', 'f_end', 'degree',
...
def tracer_sphere(tmpdir, degree):
    ...
    return TracerSetup(domain, tmax, output, f_init, f_end, degree,
                       uexpr, umax, radius, tol)
...
def tracer_slice(tmpdir, degree):
    ...
    return TracerSetup(domain, tmax, output, f_init, f_end, degree, uexpr, tol=tol)
...
def tracer_blob_slice(tmpdir, degree):
    ...
    return TracerSetup(domain, tmax, output, f_init, degree=degree)
