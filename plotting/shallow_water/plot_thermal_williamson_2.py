"""
Plots the thermal Williamson 2 test case.

The initial conditions are plotted:
(a) the velocity field, (b) the depth field, (c) buoyancy field.

And after 5 days, this plots:
(a) relative vorticity, (b) depth error (c) buoyancy error.
"""
...
# Final plot details
# ---------------------------------------------------------------------------- #
final_field_names = ['RelativeVorticity', 'D_error', 'b_error']
final_colour_schemes = ['RdBu_r', 'PiYG', 'PuOr']
final_field_labels = [r'$\zeta \ / $ s$^{-1}$', r'$\Delta D$ (m)', r'$\Delta b$ (m s$^{-2}$)']
final_contours_to_remove = [0.0, 0.0, 0.0]
