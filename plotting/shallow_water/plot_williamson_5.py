"""
Plots the Williamson 5 test case.
...
final_contours = [np.linspace(-1e-4, 1e-4, 21),
                  np.linspace(5000, 6000, 11)]
...
for i, (field_name, colour_scheme, field_label, contours, contour_to_remove) in \
    enumerate(zip(
        final_field_names, final_colour_schemes,
        final_field_labels, final_contours, final_contours_to_remove)):
