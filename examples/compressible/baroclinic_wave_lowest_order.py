from firedrake import (ExtrudedMesh, SpatialCoordinate, cos, sin, pi, sqrt, File,
...
#function to build Lowest order fucntion spces
...
dirname = 'baroclinicPerturbation_lowestorder'
