...
tmax = days * 24. * 60. * 60.
deltaz = 2.0e3
dumpfreq = int(24. * 60. * 60. / (dt)) # dumps once a day 
n = [16, 24, 32]
...
for ref in n:
    ...
    Height = 3.0e4  # height
    dx = 2*pi*a / (4*ref) # calcs cell size
    nlayers = int(Height/deltaz)

    m = GeneralCubedSphereMesh(a, num_cells_per_edge_of_panel=ref, degree=2)
