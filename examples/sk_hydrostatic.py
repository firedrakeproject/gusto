...
output = OutputParameters(dirname='sk_hydrostatic', dumpfreq=1, dumplist=['u','theta','rho'])
...
advection_dict["theta"] = EmbeddedDGAdvection(state, state.V[2], Vtdg, continuity=False)
# supg_params = {}
# supg_params["a1"] = 0.0
# advection_dict["theta"] = SUPGAdvection(state, state.V[2], direction=[1], supg_params=supg_params)
