from gusto import (
    ...
    ThermalShallowWaterEquations, logger, RelativeVorticity,
    PotentialVorticity, ShallowWaterKineticEnergy,
    ShallowWaterPotentialEnergy, ShallowWaterPotentialEnstrophy,
    ShallowWaterAvailablePotentialEnergy, SteadyStateError, IO,
...
def gamma_v(x_in):
    D = x_in.subfunctions[1]
    b = x_in.subfunctions[2]
    return (1+20.*beta2/g*sat_func(b, D))**(-1)
...
sat_adj = SWSaturationAdjustment(
    ...
    beta2=beta2, gamma_v=gamma_v, thermal_feedback=True,
