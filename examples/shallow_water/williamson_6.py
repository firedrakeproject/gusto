...
from gusto import *
from firedrake import IcosahedralSphereMesh, SpatialCoordinate, cos, grad, curl, div, TensorProductElement, CubedSphereMesh
...
for index, Mesh in enumerate(meshs):
    ...
    domain = Domain(mesh, dt, family[index], 1)
    ...
    # Output and IO
    dirname = f'Williamson6_mesh={mesh}'
