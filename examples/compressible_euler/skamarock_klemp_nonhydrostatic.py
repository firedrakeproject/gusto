...
from gusto import (
    ...
    ImplicitMidpoint, RungeKuttaFormulation, TrapeziumRule
)
...
def skamarock_klemp_nonhydrostatic(
    ...
    eqns.label_terms(lambda t: not any(t.has_label(time_derivative, eos_form, eos_mass, transport)), implicit)
