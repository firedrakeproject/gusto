...
class SurfaceFluxes(PhysicsParametrisation):
    ...
    def evaluate(self, x_out, x_in, dt):
        ...
        x_out.subfunctions[self.T_idx].assign(self.source_theta_vd)
...
class WindDrag(PhysicsParametrisation):
    ...
    def evaluate(self, x_out, x_in, dt):
        ...
        if self.implicit_formulation:
            ...
            x_out.subfunctions[self.u_idx].assign(self.source_u)
        else:
            x_out.assign(self.X)
...
class SuppressVerticalWind(PhysicsParametrisation):
    ...
    def evaluate(self, x_out, x_in, dt):
        ...
        x_out.subfunctions[self.u_idx].assign(self.wind)
...
class BoundaryLayerMixing(PhysicsParametrisation):
    ...
    def evaluate(self, x_out, x_in, dt):
        ...
        x_out.subfunctions[self.idx].assign(self.field)
