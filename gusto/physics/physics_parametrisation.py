...
from firedrake import Interpolator, Function, dx, Projector, Constant, split
...
class SourceSink(PhysicsParametrisation):
    ...
    def __init__(self, equation, variable_name, rate_expression,
        ...
        equation.residual += source_label(self.label(subject(test * self.source_expr * dx, self.source),
                                        self.evaluate))
