...
__all__ = ["SaturationAdjustment", "Fallout", "Coalescence", "EvaporationOfRain",
           "AdvectedMoments", "InstantRain", "SourceSink"]
...
class SourceSink(Physics):
    ...
    def __init__(self, equation, variable_name, rate_expression,
        ...
        Args:
            ...
            rate_expression (ufl.Expr): the saturation function, above which
        ...
        if self.method == 'interpolate':
            self.source_interpolator = Interpolator(rate_expression, V)
        else:
            self.source_projector = Projector(rate_expression, V)
