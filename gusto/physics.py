...
__all__ = ["SaturationAdjustment", "Fallout", "Coalescence", "EvaporationOfRain",
           ...
           "SourceSink", "Relaxation", "SurfaceFluxes", "WindDrag", "StaticAdjustment",
...
class Relaxation(PhysicsParametrisation):
    ...
    def __init__(self, equation, variable_name, equilibrium_expr,
                 coeff=None):
        """
        Args:
            equation (:class:`PrognosticEquationSet`): the model's equation.
        ...
        value_idx = equation.field_names.index(variable_name)
        X = equation.X
        value = split(X)[value_idx]

        # Add relaxation term to residual
        forcing = test * coeff * (value - equilibrium_expr) * dx
