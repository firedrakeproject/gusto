"""
Tests Gusto's built-in meshes: that they can be formed without error and that
they have the correct number of cells/edges/vertices.
"""

from gusto import GeneralIcosahedralSphereMesh, GeneralCubedSphereMesh
...
def test_build_mesh(mesh_type, num):
    ...
    if mesh_type == "icosahedral":
        mesh = GeneralIcosahedralSphereMesh(radius, num, degree=2)
        ncells = 20*num**2
        ...
        mesh = GeneralCubedSphereMesh(radius, num, degree=2)
        ncells = 6*num**2
