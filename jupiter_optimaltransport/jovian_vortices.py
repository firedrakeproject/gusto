...
tmax = 17280/4 * dt  # duration of the simulation (in seconds) 
# ^ 100 days
...
dirname = "jv_uniform_plane_mesh"
dumpfreq = 8640  # dumpfreq is how many iterations it does before it saves a state 
...
# courant no. should stay below 0.33, if the cells are too 
# rectangular then it goes above and this results in instabilities.
