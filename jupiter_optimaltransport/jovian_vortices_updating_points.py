...
tmax = 25920 * dt    # duration of the simulation (in seconds) 
# ^ 150 days
...
# gusto shallow water equations setup
...
def update_points(fields):
    ...
    # the minimum of the depth field is at index idx
    ...
    return points  # returns the interval of coordinates to evaluate the field at


dirname = "jv_up_pv_b1_150days" 
dumpfreq = 8640  # to give 4 outputs
pddumpfreq = dumpfreq 

# output variable includes the function for finding new cross-section points
output = OutputParameters(
    dirname=dirname, dumpfreq=dumpfreq, pddumpfreq=dumpfreq,
    dump_vtus=True, dump_nc=True,
    point_data=[('PotentialVorticity', update_points)]  
)
...
# create the initial velocity field of the vortex:
